...
proc gen_menu {} {
    ...
    foreach {link text color} {projects.html series #FF0000  tutorials.html tutos #FBBC05 About.html about #4285F4 Shop.html shop #34A853} {
	lappend MENUS [string map [list %LINK% $link %TEXT% $text %COLOR% $color] $menutemplate]
    }
...
proc gen_index {} {
    ...
    foreach {template worktemplate} [templates_load index] break
    ...
    # lappend CONTENT [h1 "Dots2Art"]
    # lappend CONTENT [h1 "Generative Dots Art"]
...
proc main {} {
    ...
    puts "generation DONE at [gensite_outputdir_temp]"
}
